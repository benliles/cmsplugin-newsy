...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'NewsItem.tags'
        db.alter_column('newsy_newsitem', 'tags', self.gf('newsy.models.TagField')())

        # Changing field 'LatestNewsPlugin.tags'
        db.alter_column('cmsplugin_latestnewsplugin', 'tags', self.gf('newsy.models.TagField')())


    def backwards(self, orm):
        
        # Changing field 'NewsItem.tags'
        db.alter_column('newsy_newsitem', 'tags', self.gf('tagging.fields.TagField')())

        # Changing field 'LatestNewsPlugin.tags'
        db.alter_column('cmsplugin_latestnewsplugin', 'tags', self.gf('tagging.fields.TagField')())
    ...
    models = {
        ...
        'newsy.latestnewsplugin': {
            ...
            'tags': ('newsy.models.TagField', [], {})
        },
        'newsy.newsitem': {
            'Meta': {'ordering': "['-publication_date', 'title']", 'object_name': 'NewsItem'},
