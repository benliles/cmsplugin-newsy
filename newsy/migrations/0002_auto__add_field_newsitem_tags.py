...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'NewsItem.tags'
        db.add_column('newsy_newsitem', 'tags', self.gf('tagging.fields.TagField')(default=''), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'NewsItem.tags'
        db.delete_column('newsy_newsitem', 'tags')
